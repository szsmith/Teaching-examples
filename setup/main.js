...
import pyodbc
cnxn = pyodbc.connect(r'Driver={SQL Server};Server=XXXXXX;Database=XXXXXXXX;UID="XXXXXX";Trusted_Connection=yes;')
sql = """SELECT TOP (10000) from XXXXXXXX """
...
# df needs to have index as date and be univariate
tsplot(df, lags=15)
plt.show()
...
#based off of example from Kaggle housing dataset
